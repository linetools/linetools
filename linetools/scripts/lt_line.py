...
def parser(options=None):
    ...
    parser.add_argument("-t", "--toler", default=1., action='store_true', help="Matching tolerance (in Ang) on input wavelength")
    parser.add_argument("-z", "--redshift", default=0., help="Matching tolerance (in Ang) on input wavelength")
